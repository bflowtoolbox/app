...
public class GMFUtility {
	...
	/**
	 * Tries to select the given graphical edit part within the given diagram
	 * edit part. If the selected edit part is not visible within the view it
	 * will scrolled until it is.
	 * 
	 * @param diagramEditPart
	 *            diagram edit part which contains the graphical edit part
	 * @param graphicalEditPart
	 *            element which will be selected
	 */
	 ...
	 *            element which will be selected
	 * @param reveal
	 *            if true, the selected element will be scrolled into the view
	 */
