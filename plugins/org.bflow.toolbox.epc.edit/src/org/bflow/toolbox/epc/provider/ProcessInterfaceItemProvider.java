...
/**
 * This is the item provider adapter for a {@link org.bflow.toolbox.epc.ProcessInterface} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProcessInterfaceItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ProcessInterface_Subdiagram_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ProcessInterface_Subdiagram_feature", "_UI_ProcessInterface_type"),
				 EpcPackage.Literals.PROCESS_INTERFACE__SUBDIAGRAM,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_ProcessInterface_type") :
