 ...
 * @generated
 */
public class InformationEdgeCreateCommand extends CreateElementCommand {
	 ...
	 * @generated
	 */
	public InformationEdgeCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return OepcBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateInformationEdge_4002(getContainer(), getSource(),
						getTarget());
	}
	...
	protected EObject doDefaultElementCreation() {
		InformationEdge newElement = OepcFactory.eINSTANCE
				.createInformationEdge();
