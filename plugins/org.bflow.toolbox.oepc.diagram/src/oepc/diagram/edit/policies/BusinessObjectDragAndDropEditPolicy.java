...
public class BusinessObjectDragAndDropEditPolicy extends GraphicalEditPolicy {
	...
	/**
	 * This will only return a command if the host is resolvable so that trying
	 * to drop on an unresolved shape will not be allowed.
	 * 
	...
	/**
	 * getDropElementCommand Returns a command to handle a DropObjectsRequest of
	 * an EObject
	 * 
	 * @param element
	...
	/**
	 * getDropObjectsCommand This provides a generic implementation for handling
	 * the DropObjectsRequest which checks for EObject and gets a command from
	 * the getDropEementCommand method.
	 * 
	 * @param request
