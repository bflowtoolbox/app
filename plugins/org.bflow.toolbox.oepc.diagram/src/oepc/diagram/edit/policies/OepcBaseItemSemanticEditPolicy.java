...
import oepc.diagram.edit.helpers.OepcBaseEditHelper;
 ...
 * @generated
 */
public class OepcBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	...
	public Command getCommand(Request request) {
		if (request instanceof ReconnectRequest) {
			...
			if (view instanceof View) {
				Integer id = new Integer(OepcVisualIDRegistry
		...
		if (elementType != null) {
			if (semanticCommand != null) {
				...
				completedRequest.setParameter(
						OepcBaseEditHelper.EDIT_POLICY_COMMAND, command);
			}
	...
	public static class LinkConstraints {
		 ...
		 * @generated
		 */
		public static boolean canCreateControlFlowEdge_4001(
				oepc.OEPC container, Element source, Element target) {
			return canExistControlFlowEdge_4001(container, source, target);
		}

		/**
		 * @generated
		 */
		public static boolean canCreateInformationEdge_4002(
				oepc.OEPC container, Element source, Element target) {
			return canExistInformationEdge_4002(container, source, target);
		}

		/**
		 * @generated
		 */
		public static boolean canExistControlFlowEdge_4001(oepc.OEPC container,
		 ...
		 * @generated
		 */
		public static boolean canExistInformationEdge_4002(oepc.OEPC container,
				Element source, Element target) {
