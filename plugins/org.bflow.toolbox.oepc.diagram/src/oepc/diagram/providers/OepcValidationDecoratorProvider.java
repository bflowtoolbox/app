...
import oepc.diagram.part.ValidationMarker;
 ...
 * @generated
 */
public class OepcValidationDecoratorProvider extends AbstractProvider implements
		IDecoratorProvider {
	 ...
	 * @generated
	 */
	private static final String MARKER_TYPE = OepcDiagramEditorPlugin.ID
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof OepcDiagramEditor) {
	...
	public boolean provides(IOperation operation) {
		...
		return view != null
				&& OEPCEditPart.MODEL_ID.equals(OepcVisualIDRegistry
						.getModelID(view));
	}
