...
import oepc.diagram.part.OepcDiagramEditorUtil;
 ...
 * @generated
 */
public class OepcMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = OepcDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			OepcDiagramEditorUtil.selectElementsInDiagram(editor, Arrays
