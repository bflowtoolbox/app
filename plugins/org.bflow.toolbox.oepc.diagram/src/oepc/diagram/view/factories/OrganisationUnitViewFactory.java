 ...
 * @generated
 */
public class OrganisationUnitViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = OepcVisualIDRegistry
					.getType(OrganisationUnitEditPart.VISUAL_ID);
		...
		BflowDiagramEditPart.apply(OrganisationUnitEditPart.class, style);
