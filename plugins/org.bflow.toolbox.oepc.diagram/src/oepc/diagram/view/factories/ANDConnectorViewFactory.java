 ...
 * @generated
 */
public class ANDConnectorViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = OepcVisualIDRegistry
					.getType(ANDConnectorEditPart.VISUAL_ID);
		...
		BflowDiagramEditPart.apply(ANDConnectorEditPart.class, style);
	}
}
