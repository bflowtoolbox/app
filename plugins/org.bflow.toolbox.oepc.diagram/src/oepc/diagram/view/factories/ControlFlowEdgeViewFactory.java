 ...
 * @generated
 */
public class ControlFlowEdgeViewFactory extends ConnectionViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = OepcVisualIDRegistry
					.getType(ControlFlowEdgeEditPart.VISUAL_ID);
		...
		BflowDiagramEditPart.apply(ControlFlowEdgeEditPart.class, style);
	}
}
