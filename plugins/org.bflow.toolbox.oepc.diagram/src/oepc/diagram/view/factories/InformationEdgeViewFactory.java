 ...
 * @generated
 */
public class InformationEdgeViewFactory extends ConnectionViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = OepcVisualIDRegistry
					.getType(InformationEdgeEditPart.VISUAL_ID);
		...
		BflowDiagramEditPart.apply(InformationEdgeEditPart.class, style);
	}
}
