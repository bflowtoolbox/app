 ...
 * @generated
 */
public class BusinessObjectViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		getViewService()
				.createNode(
						...
						view,
						OepcVisualIDRegistry
								.getType(BusinessObjectBusinessObjectAttributeCompartmentEditPart.VISUAL_ID),
						ViewUtil.APPEND, true, getPreferencesHint());
		getViewService()
				.createNode(
						eObjectAdapter,
						view,
						OepcVisualIDRegistry
								.getType(BusinessObjectBusinessObjectMethodCompartmentEditPart.VISUAL_ID),
						ViewUtil.APPEND, true, getPreferencesHint());
		...
		BflowDiagramEditPart.apply(BusinessObjectEditPart.class, style);
