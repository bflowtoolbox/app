...
public class BacktrackReverseJudgmentCommand implements Command {
	private Intention parent;
	private HumanJudgment judgment;
	
	public BacktrackReverseJudgmentCommand(Intention p, HumanJudgment hj) {
		parent = p;
		judgment = hj;
	}
	...
	public void execute() {
		System.out.println("backtracking reverse judgment in command");
		boolean r = parent.backtrackReverseJudgments(judgment);	
