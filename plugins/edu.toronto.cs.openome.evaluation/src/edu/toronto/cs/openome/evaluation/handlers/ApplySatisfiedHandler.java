 ...
 * @author arupghose
 */
public class ApplySatisfiedHandler extends ReasonerHandler{
	
	ModelImpl model;
	CommandStack cs;

	public ApplySatisfiedHandler() {
		super();
	}
			...
			if (selection instanceof IStructuredSelection) {
				...
				for (int i = 0; i < selectionSize; i++) {
					...
					try {
						...
						SetQualitativeEvaluationLabelCommand setLabel = new SetQualitativeEvaluationLabelCommand(partIntention, EvaluationLabel.SATISFIED);
						cs.execute(setLabel);
