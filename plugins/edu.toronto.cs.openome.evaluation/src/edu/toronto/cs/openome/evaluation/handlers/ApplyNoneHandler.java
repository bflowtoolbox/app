 ...
 * @author arupghose
 */
public class ApplyNoneHandler extends ReasonerHandler{
	
	ModelImpl model;
	CommandStack cs;

	public ApplyNoneHandler() {
		super();
	}
			...
			if (selection instanceof IStructuredSelection) {
				...
				for (int i = 0; i < selectionSize; i++) {
					...
					try {
						...
						SetQualitativeEvaluationLabelCommand setLabel = new SetQualitativeEvaluationLabelCommand(partIntention, EvaluationLabel.NONE);
						cs.execute(setLabel);
