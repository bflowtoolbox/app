 ...
 * @author arupghose
 */
public class ApplyDeniedHandler extends ReasonerHandler{
	
	ModelImpl model;
	CommandStack cs;

	public ApplyDeniedHandler() {
		super();
	}
			...
			if (selection instanceof IStructuredSelection) {
				...
				for (int i = 0; i < selectionSize; i++) {
					...
					try {
						...
						SetQualitativeEvaluationLabelCommand setLabel = new SetQualitativeEvaluationLabelCommand(partIntention, EvaluationLabel.DENIED);
						cs.execute(setLabel);
