...
public class RemoveReverseJudgmentCommand implements Command {
	private Intention target;
	
	public RemoveReverseJudgmentCommand(Intention t) {
		target = t;
	}
	...
	public void execute() {
		System.out.println("Clearing reverse label bag in command");
		target.getReverseLabelBag().clearLabelBag();		
	}
