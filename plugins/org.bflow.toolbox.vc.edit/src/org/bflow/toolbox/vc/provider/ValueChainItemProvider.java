...
/**
 * This is the item provider adapter for a {@link org.bflow.toolbox.vc.ValueChain} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ValueChainItemProvider
	 ...
	 * @generated
	 */
	public ValueChainItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ValueChain"));
	}
	...
	public String getText(Object object) {
		String label = ((ValueChain)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ValueChain_type") :
			getString("_UI_ValueChain_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ValueChain.class)) {
