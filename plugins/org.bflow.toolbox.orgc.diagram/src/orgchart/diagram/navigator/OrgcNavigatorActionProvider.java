...
import orgchart.diagram.part.Messages;
 ...
 * @generated
 */
public class OrgcNavigatorActionProvider extends CommonActionProvider {
	...
	private static class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof OrgcNavigatorItem) {
					selectedElement = ((OrgcNavigatorItem) selectedElement)
							.getView();
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, OrgcDiagramEditor.ID);
