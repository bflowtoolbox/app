...
import orgchart.diagram.part.OrgcDiagramEditor;
 ...
 * @generated
 */
public class OrgcValidationDecoratorProvider extends AbstractProvider implements
		IDecoratorProvider {
	 ...
	 * @generated
	 */
	private static final String MARKER_TYPE = OrgcDiagramEditorPlugin.ID
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof OrgcDiagramEditor) {
	...
	public boolean provides(IOperation operation) {
		...
		return view != null
				&& ModelEditPart.MODEL_ID.equals(OrgcVisualIDRegistry
						.getModelID(view));
	}
