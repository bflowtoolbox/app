...
import orgchart.diagram.part.OrgcDiagramEditorUtil;

/**
 * @generated
 */
public class OrgcMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = OrgcDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			OrgcDiagramEditorUtil.selectElementsInDiagram(editor,
