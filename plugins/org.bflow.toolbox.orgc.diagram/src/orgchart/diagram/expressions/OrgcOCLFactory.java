 ...
 * 
 */
package orgchart.diagram.expressions;
 ...
 * @generated
 */
public class OrgcOCLFactory {

	/**
	 * @generated
	 */
	private final OrgcAbstractExpression[] expressions;
	 ...
	 * @generated
	 */
	private static OrgcOCLFactory getInstance() {
		OrgcOCLFactory instance = OrgcDiagramEditorPlugin.getInstance()
				.getOrgcOCLFactory();
		if (instance == null) {
			OrgcDiagramEditorPlugin.getInstance().setOrgcOCLFactory(
					instance = new OrgcOCLFactory());
		}
		return instance;
	}
	 ...
	 * @generated
	 */
	public static OrgcAbstractExpression getExpression(int index,
			EClassifier context, Map<String, EClassifier> environment) {
		OrgcOCLFactory cached = getInstance();
	 ...
	 * @generated
	 */
	public static OrgcAbstractExpression getExpression(String body,
			EClassifier context, Map<String, EClassifier> environment) {
	 ...
	 * @generated
	 */
	private static class Expression extends OrgcAbstractExpression {
