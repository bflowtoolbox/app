 ...
 * @generated
 */
public abstract class OrgcAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = OrgcDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected OrgcAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
