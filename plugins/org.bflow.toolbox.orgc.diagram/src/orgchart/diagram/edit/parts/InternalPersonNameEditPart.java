 ...
 * @generated
 */
public class InternalPersonNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
			...
			parser = OrgcParserProvider
					.getParser(
							...
							OrgcVisualIDRegistry
									.getType(orgchart.diagram.edit.parts.InternalPersonNameEditPart.VISUAL_ID));
		}
		return parser;
	}
