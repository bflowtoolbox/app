...
public class PositionEditPart extends  BflowNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new PositionItemSemanticEditPolicy());
	...
	public class PositionFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			LinkContext linkContext = new LinkContext(() -> ((Position) PositionEditPart.this.getPrimaryView().getElement()).getSubdiagram());
