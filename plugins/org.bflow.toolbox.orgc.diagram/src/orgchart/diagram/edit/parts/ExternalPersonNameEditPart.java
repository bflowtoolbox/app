 ...
 * @generated
 */
public class ExternalPersonNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
			...
			parser = OrgcParserProvider
					.getParser(
							...
							OrgcVisualIDRegistry
									.getType(orgchart.diagram.edit.parts.ExternalPersonNameEditPart.VISUAL_ID));
		}
		return parser;
	}
