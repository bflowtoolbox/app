...
import orgchart.diagram.edit.policies.OrgcTextSelectionEditPolicy;
 ...
 * @generated
 */
public class ParticipantNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new OrgcTextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = OrgcParserProvider
					.getParser(
							OrgcElementTypes.Participant_2005,
							getParserElement(),
							OrgcVisualIDRegistry
									.getType(orgchart.diagram.edit.parts.ParticipantNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					OrgcEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
