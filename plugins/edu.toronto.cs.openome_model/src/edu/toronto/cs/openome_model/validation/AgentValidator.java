...
/**
 * A sample validator interface for {@link edu.toronto.cs.openome_model.Agent}.
...
public interface AgentValidator {
	...
	boolean validatePlays(EList<Role> value);
	boolean validateOccupies(EList<Position> value);
	boolean validateIns(Agent value);
}
