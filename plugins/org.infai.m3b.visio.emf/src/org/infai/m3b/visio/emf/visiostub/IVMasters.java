...
public class IVMasters extends DispatchPtr {
	public static final GUID DIID = new GUID("{000d0708-0000-0000-C000-000000000046}");
	public static final int IID_TOKEN;
	static {
		IID_TOKEN = IdentityManager.registerProxy(DIID, IVMasters.class);
	}
	 ...
	 * IVMasters (it is required by Jawin for some internal working though).
	 */
	public IVMasters() {
		super();
	}
	 ...
	 * the IVMasters interface.
	 * 
	 * @param progid the progid of the COM-object to create.
	 */
	public IVMasters(String progid) throws COMException {
		super(progid, DIID);
	}
	 ...
	 */
	public IVMasters(GUID clsid) throws COMException {
		super(clsid, DIID);
	}

	/**
	 * For getting the IVMasters interface on an existing COM-object.
	 * This is an alternative to calling {@link #queryInterface(Class)}
	 * on comObject.
	 * 
	 * @param comObject the COM-object to get the IVMasters interface on.
	 */
	public IVMasters(COMPtr comObject) throws COMException {
		super(comObject);
	}
    ...
    * @return void
    **/
    public IVMaster getItem(Variant NameUIDOrIndex) throws COMException
    {
    ...
    * @return void
    **/
    public IVMaster Add() throws COMException
    {
      IVMaster res = new IVMaster();
    ...
    * @return void
    **/
    public IVMaster getItemU(Variant NameUIDOrIndex) throws COMException
    {
        IVMaster res = new IVMaster();
    ...
    * @return void
    **/
    public IVMaster getItemFromID(int nID) throws COMException
    {
        IVMaster res = new IVMaster();
    ...
    * @return void
    **/
    public IVMaster AddEx(int Type) throws COMException
    {
      IVMaster res = new IVMaster();
          DispatchPtr dispPtr = (DispatchPtr)invokeN("AddEx", new Object[] {new Integer(Type)});
          res.stealUnknown(dispPtr);
          return res;
