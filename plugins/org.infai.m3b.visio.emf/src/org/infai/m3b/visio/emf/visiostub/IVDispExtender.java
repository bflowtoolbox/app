 ...
 *
 * Dispatch: IVDispExtender
 * Description: Dispatch interface of extensions Visio gives to a control contained in a Visio Document.
 * Help file:   C:\Program Files\Microsoft Office\Office12\Vis_SDR.CHM
 *
 * @author JawinTypeBrowser
 */

public class IVDispExtender extends DispatchPtr {
	public static final GUID DIID = new GUID("{000d0d0f-0000-0000-C000-000000000046}");
	public static final int IID_TOKEN;
	static {
		IID_TOKEN = IdentityManager.registerProxy(DIID, IVDispExtender.class);
	}
	 ...
	 * IVDispExtender (it is required by Jawin for some internal working though).
	 */
	public IVDispExtender() {
		super();
	}

	/**
	 * For creating a new COM-object with the given progid and with 
	 * the IVDispExtender interface.
	 * 
	 * @param progid the progid of the COM-object to create.
	 */
	public IVDispExtender(String progid) throws COMException {
		super(progid, DIID);
	}
	 ...
	 */
	public IVDispExtender(GUID clsid) throws COMException {
		super(clsid, DIID);
	}

	/**
	 * For getting the IVDispExtender interface on an existing COM-object.
	 * This is an alternative to calling {@link #queryInterface(Class)}
	 * on comObject.
	 * 
	 * @param comObject the COM-object to get the IVDispExtender interface on.
	 */
	public IVDispExtender(COMPtr comObject) throws COMException {
		super(comObject);
	}
