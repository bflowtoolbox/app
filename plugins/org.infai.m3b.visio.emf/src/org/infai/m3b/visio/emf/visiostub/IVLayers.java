...
public class IVLayers extends DispatchPtr {
	public static final GUID DIID = new GUID("{000d0713-0000-0000-C000-000000000046}");
	public static final int IID_TOKEN;
	static {
		IID_TOKEN = IdentityManager.registerProxy(DIID, IVLayers.class);
	}
	 ...
	 * IVLayers (it is required by Jawin for some internal working though).
	 */
	public IVLayers() {
		super();
	}
	 ...
	 * the IVLayers interface.
	 * 
	 * @param progid the progid of the COM-object to create.
	 */
	public IVLayers(String progid) throws COMException {
		super(progid, DIID);
	}
	 ...
	 */
	public IVLayers(GUID clsid) throws COMException {
		super(clsid, DIID);
	}

	/**
	 * For getting the IVLayers interface on an existing COM-object.
	 * This is an alternative to calling {@link #queryInterface(Class)}
	 * on comObject.
	 * 
	 * @param comObject the COM-object to get the IVLayers interface on.
	 */
	public IVLayers(COMPtr comObject) throws COMException {
		super(comObject);
	}
    ...
    * @return void
    **/
    public IVLayer getItem(Variant NameOrIndex) throws COMException
    {
    ...
    * @return void
    **/
    public IVLayer Add(String LayerName) throws COMException
    {
      IVLayer res = new IVLayer();
          DispatchPtr dispPtr = (DispatchPtr)invokeN("Add", new Object[] {LayerName});
          res.stealUnknown(dispPtr);
          return res;
    ...
    * @return void
    **/
    public IVLayer getItemU(Variant NameOrIndex) throws COMException
    {
        IVLayer res = new IVLayer();
