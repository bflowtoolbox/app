...
public class IVSection extends DispatchPtr {
	public static final GUID DIID = new GUID("{000d0724-0000-0000-C000-000000000046}");
	public static final int IID_TOKEN;
	static {
		IID_TOKEN = IdentityManager.registerProxy(DIID, IVSection.class);
	}
	 ...
	 * IVSection (it is required by Jawin for some internal working though).
	 */
	public IVSection() {
		super();
	}
	 ...
	 * the IVSection interface.
	 * 
	 * @param progid the progid of the COM-object to create.
	 */
	public IVSection(String progid) throws COMException {
		super(progid, DIID);
	}
	 ...
	 */
	public IVSection(GUID clsid) throws COMException {
		super(clsid, DIID);
	}

	/**
	 * For getting the IVSection interface on an existing COM-object.
	 * This is an alternative to calling {@link #queryInterface(Class)}
	 * on comObject.
	 * 
	 * @param comObject the COM-object to get the IVSection interface on.
	 */
	public IVSection(COMPtr comObject) throws COMException {
		super(comObject);
	}
    ...
    * @return void
    **/
    public IVRow getRow(short Index) throws COMException
    {
        IVRow res = new IVRow();
          DispatchPtr dispPtr = (DispatchPtr)get("Row", new Short(Index));
          res.stealUnknown(dispPtr);
          return res;
    }
