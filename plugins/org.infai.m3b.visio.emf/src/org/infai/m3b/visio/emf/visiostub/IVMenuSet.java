...
public class IVMenuSet extends DispatchPtr {
	public static final GUID DIID = new GUID("{000d0232-0000-0000-C000-000000000046}");
	public static final int IID_TOKEN;
	static {
		IID_TOKEN = IdentityManager.registerProxy(DIID, IVMenuSet.class);
	}
	 ...
	 * IVMenuSet (it is required by Jawin for some internal working though).
	 */
	public IVMenuSet() {
		super();
	}
	 ...
	 * the IVMenuSet interface.
	 * 
	 * @param progid the progid of the COM-object to create.
	 */
	public IVMenuSet(String progid) throws COMException {
		super(progid, DIID);
	}
	 ...
	 */
	public IVMenuSet(GUID clsid) throws COMException {
		super(clsid, DIID);
	}

	/**
	 * For getting the IVMenuSet interface on an existing COM-object.
	 * This is an alternative to calling {@link #queryInterface(Class)}
	 * on comObject.
	 * 
	 * @param comObject the COM-object to get the IVMenuSet interface on.
	 */
	public IVMenuSet(COMPtr comObject) throws COMException {
		super(comObject);
	}
    ...
    * @return void
    **/
    public IVMenus getMenus() throws COMException
    {
        IVMenus res = new IVMenus();
          DispatchPtr dispPtr = (DispatchPtr)get("Menus");
    ...
    * @return void
    **/
    public IVMenuSets getParent() throws COMException
    {
