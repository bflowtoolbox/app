...
public class IVToolbarItem extends DispatchPtr {
	public static final GUID DIID = new GUID("{000d0242-0000-0000-C000-000000000046}");
	public static final int IID_TOKEN;
	static {
		IID_TOKEN = IdentityManager.registerProxy(DIID, IVToolbarItem.class);
	}
	 ...
	 * IVToolbarItem (it is required by Jawin for some internal working though).
	 */
	public IVToolbarItem() {
		super();
	}

	/**
	 * For creating a new COM-object with the given progid and with 
	 * the IVToolbarItem interface.
	 * 
	 * @param progid the progid of the COM-object to create.
	 */
	public IVToolbarItem(String progid) throws COMException {
		super(progid, DIID);
	}
	 ...
	 */
	public IVToolbarItem(GUID clsid) throws COMException {
		super(clsid, DIID);
	}

	/**
	 * For getting the IVToolbarItem interface on an existing COM-object.
	 * This is an alternative to calling {@link #queryInterface(Class)}
	 * on comObject.
	 * 
	 * @param comObject the COM-object to get the IVToolbarItem interface on.
	 */
	public IVToolbarItem(COMPtr comObject) throws COMException {
		super(comObject);
	}
    ...
    * @return void
    **/
    public IVToolbarItems getParent() throws COMException
    {
