...
public class IVStatusBarItem extends DispatchPtr {
	public static final GUID DIID = new GUID("{000d0272-0000-0000-C000-000000000046}");
	public static final int IID_TOKEN;
	static {
		IID_TOKEN = IdentityManager.registerProxy(DIID, IVStatusBarItem.class);
	}
	 ...
	 * IVStatusBarItem (it is required by Jawin for some internal working though).
	 */
	public IVStatusBarItem() {
		super();
	}

	/**
	 * For creating a new COM-object with the given progid and with 
	 * the IVStatusBarItem interface.
	 * 
	 * @param progid the progid of the COM-object to create.
	 */
	public IVStatusBarItem(String progid) throws COMException {
		super(progid, DIID);
	}
	 ...
	 */
	public IVStatusBarItem(GUID clsid) throws COMException {
		super(clsid, DIID);
	}

	/**
	 * For getting the IVStatusBarItem interface on an existing COM-object.
	 * This is an alternative to calling {@link #queryInterface(Class)}
	 * on comObject.
	 * 
	 * @param comObject the COM-object to get the IVStatusBarItem interface on.
	 */
	public IVStatusBarItem(COMPtr comObject) throws COMException {
		super(comObject);
	}
    ...
    * @return void
    **/
    public IVStatusBarItems getParent() throws COMException
    {
