 ...
 *
 * Dispatch: EPage
 * Description: Visio Page Event Interface
 * Help file:   C:\Program Files\Microsoft Office\Office12\Vis_SDR.CHM
 *
 * @author JawinTypeBrowser
 */

public class EPage extends DispatchPtr {
	public static final GUID DIID = new GUID("{000d0b0a-0000-0000-C000-000000000046}");
	public static final int IID_TOKEN;
	static {
		IID_TOKEN = IdentityManager.registerProxy(DIID, EPage.class);
	}
	 ...
	 * EPage (it is required by Jawin for some internal working though).
	 */
	public EPage() {
		super();
	}
	 ...
	 */
	public EPage(String progid) throws COMException {
		super(progid, DIID);
	}
	 ...
	 */
	public EPage(GUID clsid) throws COMException {
		super(clsid, DIID);
	}

	/**
	 * For getting the EPage interface on an existing COM-object.
	 * This is an alternative to calling {@link #queryInterface(Class)}
	 * on comObject.
	 * 
	 * @param comObject the COM-object to get the EPage interface on.
	 */
	public EPage(COMPtr comObject) throws COMException {
		super(comObject);
	}
