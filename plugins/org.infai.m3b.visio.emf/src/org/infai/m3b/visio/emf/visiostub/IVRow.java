...
public class IVRow extends DispatchPtr {
	public static final GUID DIID = new GUID("{000d0725-0000-0000-C000-000000000046}");
	public static final int IID_TOKEN;
	static {
		IID_TOKEN = IdentityManager.registerProxy(DIID, IVRow.class);
	}
	 ...
	 * IVRow (it is required by Jawin for some internal working though).
	 */
	public IVRow() {
		super();
	}
	 ...
	 */
	public IVRow(String progid) throws COMException {
		super(progid, DIID);
	}
	 ...
	 */
	public IVRow(GUID clsid) throws COMException {
		super(clsid, DIID);
	}

	/**
	 * For getting the IVRow interface on an existing COM-object.
	 * This is an alternative to calling {@link #queryInterface(Class)}
	 * on comObject.
	 * 
	 * @param comObject the COM-object to get the IVRow interface on.
	 */
	public IVRow(COMPtr comObject) throws COMException {
		super(comObject);
	}
    ...
    * @return void
    **/
    public IVSection getContainingSection() throws COMException
    {
        IVSection res = new IVSection();
          DispatchPtr dispPtr = (DispatchPtr)get("ContainingSection");
          res.stealUnknown(dispPtr);
          return res;
    }
    ...
    * @return void
    **/
    public IVCell getCell(Variant NameOrIndex) throws COMException
    {
        IVCell res = new IVCell();
          DispatchPtr dispPtr = (DispatchPtr)get("Cell", NameOrIndex);
          res.stealUnknown(dispPtr);
          return res;
    }
    ...
    * @return void
    **/
    public IVCell getCellU(Variant NameOrIndex) throws COMException
    {
        IVCell res = new IVCell();
          DispatchPtr dispPtr = (DispatchPtr)get("CellU", NameOrIndex);
          res.stealUnknown(dispPtr);
          return res;
    }
    ...
    * @return void
    **/
    public void GetPolylineData(short Flags,Object[] xyArray) throws COMException
    {
      
		invokeN("GetPolylineData", new Object[] {new Short(Flags), xyArray});
