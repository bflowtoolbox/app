 ...
 *
 * Dispatch: EWindow
 * Description: Visio Window Event Interface
 * Help file:   C:\Program Files\Microsoft Office\Office12\Vis_SDR.CHM
 *
 * @author JawinTypeBrowser
 */

public class EWindow extends DispatchPtr {
	public static final GUID DIID = new GUID("{000d0b02-0000-0000-C000-000000000046}");
	public static final int IID_TOKEN;
	static {
		IID_TOKEN = IdentityManager.registerProxy(DIID, EWindow.class);
	}
	 ...
	 * EWindow (it is required by Jawin for some internal working though).
	 */
	public EWindow() {
		super();
	}
	 ...
	 * the EWindow interface.
	 * 
	 * @param progid the progid of the COM-object to create.
	 */
	public EWindow(String progid) throws COMException {
		super(progid, DIID);
	}
	 ...
	 */
	public EWindow(GUID clsid) throws COMException {
		super(clsid, DIID);
	}

	/**
	 * For getting the EWindow interface on an existing COM-object.
	 * This is an alternative to calling {@link #queryInterface(Class)}
	 * on comObject.
	 * 
	 * @param comObject the COM-object to get the EWindow interface on.
	 */
	public EWindow(COMPtr comObject) throws COMException {
		super(comObject);
	}
