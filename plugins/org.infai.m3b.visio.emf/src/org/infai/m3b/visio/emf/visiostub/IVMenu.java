...
public class IVMenu extends DispatchPtr {
	public static final GUID DIID = new GUID("{000d0222-0000-0000-C000-000000000046}");
	public static final int IID_TOKEN;
	static {
		IID_TOKEN = IdentityManager.registerProxy(DIID, IVMenu.class);
	}
	 ...
	 * IVMenu (it is required by Jawin for some internal working though).
	 */
	public IVMenu() {
		super();
	}
	 ...
	 * the IVMenu interface.
	 * 
	 * @param progid the progid of the COM-object to create.
	 */
	public IVMenu(String progid) throws COMException {
		super(progid, DIID);
	}
	 ...
	 */
	public IVMenu(GUID clsid) throws COMException {
		super(clsid, DIID);
	}

	/**
	 * For getting the IVMenu interface on an existing COM-object.
	 * This is an alternative to calling {@link #queryInterface(Class)}
	 * on comObject.
	 * 
	 * @param comObject the COM-object to get the IVMenu interface on.
	 */
	public IVMenu(COMPtr comObject) throws COMException {
		super(comObject);
	}
    ...
    * @param MDIWindowMenu
    **/
    public void setMDIWindowMenu(short MDIWindowMenu) throws COMException
    {
        put("MDIWindowMenu", MDIWindowMenu);
    }
    ...
    * @return short
    **/
    public short getMDIWindowMenu() throws COMException
    {
        return ((Short)get("MDIWindowMenu")).shortValue();
    }
    ...
    * @return void
    **/
    public IVMenus getParent() throws COMException
    {
        IVMenus res = new IVMenus();
