	...
	public EditPart createEditPart(EditPart context, Object model) {
		if (model instanceof View) {
			...
			case VCEditPart.VISUAL_ID:
				return new VCEditPart(view);

			case ValueChainEditPart.VISUAL_ID:
				return new ValueChainEditPart(view);

			case ValueChainNameEditPart.VISUAL_ID:
				return new ValueChainNameEditPart(view);

			case ValueChain2EditPart.VISUAL_ID:
				return new ValueChain2EditPart(view);

			case ValueChain2NameEditPart.VISUAL_ID:
				return new ValueChain2NameEditPart(view);
			...
			case PredecessorConnectionEditPart.VISUAL_ID:
				return new PredecessorConnectionEditPart(view);

			case ProcessSuperiorityEditPart.VISUAL_ID:
				return new ProcessSuperiorityEditPart(view);
