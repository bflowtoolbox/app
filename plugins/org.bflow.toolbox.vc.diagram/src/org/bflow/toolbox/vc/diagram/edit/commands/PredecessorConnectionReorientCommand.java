 ...
 * @generated
 */
public class PredecessorConnectionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public PredecessorConnectionReorientCommand(
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof PredecessorConnection) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return VcBaseItemSemanticEditPolicy.LinkConstraints
				.canExistPredecessorConnection_4001(container, getNewSource(),
						target);
	}
	...
	protected boolean canReorientTarget() {
		...
		Vc container = (Vc) getLink().eContainer();
		return VcBaseItemSemanticEditPolicy.LinkConstraints
				.canExistPredecessorConnection_4001(container, source,
						getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected PredecessorConnection getLink() {
		return (PredecessorConnection) getElementToEdit();
	}
