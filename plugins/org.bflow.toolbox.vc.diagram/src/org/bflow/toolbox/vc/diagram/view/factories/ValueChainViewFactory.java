 ...
 * @generated
 */
public class ValueChainViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = VcVisualIDRegistry
					.getType(ValueChainEditPart.VISUAL_ID);
		...
		getViewService().createNode(eObjectAdapter, view,
				VcVisualIDRegistry.getType(ValueChainNameEditPart.VISUAL_ID),
