 ...
 * @generated
 */
public class ValueChain2ViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = VcVisualIDRegistry
					.getType(ValueChain2EditPart.VISUAL_ID);
		...
		if (!VCEditPart.MODEL_ID.equals(VcVisualIDRegistry
			...
			shortcutAnnotation.getDetails().put("modelID", VCEditPart.MODEL_ID); //$NON-NLS-1$
		...
		getViewService().createNode(eObjectAdapter, view,
				VcVisualIDRegistry.getType(ValueChain2NameEditPart.VISUAL_ID),
