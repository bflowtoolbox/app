 ...
 * @generated
 */
public class ProcessSuperiorityCreateCommand extends CreateElementCommand {
	 ...
	 * @generated
	 */
	private Vc container;

	/**
	 * @generated
	 */
	public ProcessSuperiorityCreateCommand(CreateRelationshipRequest request,
			EObject source, EObject target) {
		super(request);
		this.source = source;
		this.target = target;
		if (request.getContainmentFeature() == null) {
			setContainmentFeature(VcPackage.eINSTANCE.getVc_Connections());
		}
	...
	public boolean canExecute() {
		...
		return VcBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateProcessSuperiority_4002(getContainer(), getSource(),
						getTarget());
	}
	...
	protected EObject doDefaultElementCreation() {
		ProcessSuperiority newElement = VcFactory.eINSTANCE
				.createProcessSuperiority();
	...
	protected EClass getEClassToEdit() {
		return VcPackage.eINSTANCE.getVc();
	}
