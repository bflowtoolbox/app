...
import org.bflow.toolbox.vc.diagram.edit.parts.VcEditPartFactory;
 ...
 * @generated
 */
public class VcEditPartProvider extends AbstractEditPartProvider {
	...
	public VcEditPartProvider() {
		setFactory(new VcEditPartFactory());
	...
	public synchronized boolean provides(IOperation operation) {
		if (operation instanceof CreateGraphicEditPartOperation) {
			...
			if (!VCEditPart.MODEL_ID
					.equals(VcVisualIDRegistry.getModelID(view))) {
				return false;
			}
