 ...
 * @generated
 */
public class VcValidationDecoratorProvider extends AbstractProvider implements
		IDecoratorProvider {
	 ...
	 * @generated
	 */
	private static final String MARKER_TYPE = VcDiagramEditorPlugin.ID
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof VcDiagramEditor) {
	...
	public boolean provides(IOperation operation) {
		...
		return view != null
				&& ModelEditPart.MODEL_ID.equals(VcVisualIDRegistry
						.getModelID(view));
	}
