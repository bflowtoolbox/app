...
import vcchart.diagram.part.VcDiagramEditorUtil;

/**
 * @generated
 */
public class VcMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = VcDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			VcDiagramEditorUtil.selectElementsInDiagram(editor,
