...
import vcchart.diagram.edit.policies.VcTextSelectionEditPolicy;
...
public class TechnicalTermNameEditPart extends CompartmentEditPart implements
	...
	public IParser getParser() {
		if (parser == null) {
			parser = VcParserProvider
					.getParser(
							VcElementTypes.TechnicalTerm_2006,
							getParserElement(),
							VcVisualIDRegistry
									.getType(vcchart.diagram.edit.parts.TechnicalTermNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					VcEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
