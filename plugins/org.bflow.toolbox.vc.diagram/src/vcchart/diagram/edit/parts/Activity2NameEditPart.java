 ...
 * @generated
 */
public class Activity2NameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public Activity2NameEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = VcParserProvider
					.getParser(
							...
							getParserElement(),
							VcVisualIDRegistry
									.getType(vcchart.diagram.edit.parts.Activity2NameEditPart.VISUAL_ID));
		}
		return parser;
	}
