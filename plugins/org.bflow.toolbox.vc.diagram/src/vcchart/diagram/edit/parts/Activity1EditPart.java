...
public class Activity1EditPart extends BflowNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Activity1ItemSemanticEditPolicy());
	...
	public class Activity1Figure extends ScalablePolygonShape {
		...
		private void createContents() {
			...
			LinkContext linkContext = new LinkContext(() -> ((Activity1) Activity1EditPart.this.getPrimaryView().getElement()).getSubdiagram());
