 ...
 * @generated
 */
public class Activity1NameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public Activity1NameEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = VcParserProvider
					.getParser(
							...
							getParserElement(),
							VcVisualIDRegistry
									.getType(vcchart.diagram.edit.parts.Activity1NameEditPart.VISUAL_ID));
		}
		return parser;
	}
