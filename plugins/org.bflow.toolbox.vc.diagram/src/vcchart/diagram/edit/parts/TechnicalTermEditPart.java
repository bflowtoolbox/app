...
public class TechnicalTermEditPart extends BflowNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new TechnicalTermItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof TechnicalTermNameEditPart) {
			((TechnicalTermNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureTechnicalTermLabelFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(VcVisualIDRegistry.getType(TechnicalTermNameEditPart.VISUAL_ID));
	}
	...
	public class TechnicalTermFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			fFigureTechnicalTermLabelFigure.setText("");
			fFigureTechnicalTermLabelFigure.setTextWrap(true);
			fFigureTechnicalTermLabelFigure.setBorder(new MarginBorder(getMapMode().DPtoLP(4), getMapMode().DPtoLP(4), getMapMode().DPtoLP(4),
					getMapMode().DPtoLP(4)));
	...
	public WrappingLabel[] getLabels() {
		return new WrappingLabel[] { ((TechnicalTermFigure) primaryShape).getFigureTechnicalTermLabelFigure() };
	}
