...
/**
 * Implements a decoration provider for the add-on plug-in.
 * 
 ...
 *
 */
public class AddonDiagramDecorationProvider extends AbstractProvider implements IDecoratorProvider {
		
	/**
	 * @generated
	 */
	private static final String KEY = "addonValidationStatus"; //$NON-NLS-1$

	/**
	 * marker id
	 */
	private static final String MARKER_TYPE = DiagramMarkerNavigationProvider.MARKER_TYPE;
	 ...
	 * Constructor.
	 */
	public AddonDiagramDecorationProvider() {
	}
	...
	public boolean provides(IOperation operation) {
		...
		return view != null; /*
				&& EpcEditPart.MODEL_ID.equals(EpcVisualIDRegistry
						.getModelID(view));*/
	}
