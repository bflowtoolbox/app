 ...
 * @generated
 */
public class ObjectiveImpl extends NamedElementImpl implements Objective {
	/**
	 * @generated NOT
	 */
	...
	protected EClass eStaticClass() {
		return VcchartPackage.Literals.OBJECTIVE;
	}
	...
	public void setSubdiagram(String value) {
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VcchartPackage.OBJECTIVE__SUBDIAGRAM, _subdiagram, value));
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID)
		{
			case VcchartPackage.OBJECTIVE__SUBDIAGRAM:
			{
