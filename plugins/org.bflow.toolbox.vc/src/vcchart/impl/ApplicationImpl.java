...
public class ApplicationImpl extends NamedElementImpl implements Application {
	...
	protected EClass eStaticClass() {
		return VcchartPackage.Literals.APPLICATION;
	}
	...
	public void setSubdiagram(String value) {
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VcchartPackage.APPLICATION__SUBDIAGRAM, _subdiagram, value));
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID)
		{
			case VcchartPackage.APPLICATION__SUBDIAGRAM:
			{
