 ...
 * <ul>
 *   <li>{@link vcchart.impl.Relation1Impl#getSource <em>Source</em>}</li>
 *   <li>{@link vcchart.impl.Relation1Impl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class Relation1Impl extends MinimalEObjectImpl.Container implements Relation1 {
	...
	protected EClass eStaticClass() {
		return VcchartPackage.Literals.RELATION1;
	}
		...
		if (source != null && source.eIsProxy()) {
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, VcchartPackage.RELATION1__SOURCE, oldSource, source));
			}
		}
		return source;
	}
	...
	public void setSource(All_Rel_1 newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VcchartPackage.RELATION1__SOURCE, oldSource, source));
	}
	...
	public All_Rel_1 getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, VcchartPackage.RELATION1__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(All_Rel_1 newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VcchartPackage.RELATION1__TARGET, oldTarget, target));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VcchartPackage.RELATION1__SOURCE:
				if (resolve) return getSource();
				return basicGetSource();
			case VcchartPackage.RELATION1__TARGET:
