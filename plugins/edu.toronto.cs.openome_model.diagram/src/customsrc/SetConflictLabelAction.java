...
public class SetConflictLabelAction extends SetEvaluationLabelAction {
	
	private EvaluationLabel privateEvalLabel = EvaluationLabel.CONFLICT;
	private String privateID = "SetConflictLabelAction";
	private String privateEvalLabelText = "Conflict";
	private String imageFile = "conflictEval.png";
	
	protected SetConflictLabelAction(IWorkbenchPage workbenchPage) {
		super(workbenchPage);
