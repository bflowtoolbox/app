...
public class UnHighlightAction extends AbstractActionHandler {
    
    private String privateID = "UnHighlightAction"; // this is how plugin.xml recognizes us
    private String privateCommandLabel = "UnHighlight"; //this is what the user sees in their context menu
    
    /**
     * The constructor
     */
    protected UnHighlightAction (IWorkbenchPage workbenchPage){
        super(workbenchPage);
        init();
    }
    ...
    protected void doRun(IProgressMonitor progressMonitor) {
        ...
        HighlightIntentionsCommand highlight = new HighlightIntentionsCommand(selection.toList(), intentions, "");
