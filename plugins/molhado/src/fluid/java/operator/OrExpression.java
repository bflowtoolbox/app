// Generated from C:\eclipse\workspace\fluid\code\fluid\java\operator\OrExpression.op.  Do *NOT* edit!
...
public class OrExpression extends LogBinopExpression { 
  protected OrExpression() {}

  public static final OrExpression prototype = new OrExpression();
  ...
  public static IRNode getOp1(IRNode node) {
    ...
    if (!(op instanceof OrExpression)) {
      throw new IllegalArgumentException("node not OrExpression: "+op);
    }
