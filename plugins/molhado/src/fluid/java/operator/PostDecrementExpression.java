// Generated from C:\eclipse\workspace\fluid\code\fluid\java\operator\PostDecrementExpression.op.  Do *NOT* edit!
...
public class PostDecrementExpression extends CrementExpression { 
  protected PostDecrementExpression() {}

  public static final PostDecrementExpression prototype = new PostDecrementExpression();
  ...
  public static IRNode getOp(IRNode node) {
    ...
    if (!(op instanceof PostDecrementExpression)) {
      throw new IllegalArgumentException("node not PostDecrementExpression: "+op);
    }
