// Generated from C:\eclipse\workspace\fluid\code\fluid\java\operator\NamedType.op.  Do *NOT* edit!
...
public class NamedType extends JavaOperator implements ReferenceType, ImportNameInterface 
    { 
  protected NamedType() {}

  public static final NamedType prototype = new NamedType();
  ...
  public static JavaNode createNode(String type) {
    return createNode(tree, type);
  }
  public static JavaNode createNode(SyntaxTreeInterface tree, String type) {
    JavaNode _result = new JavaNode(tree, prototype);
    JavaNode.setInfo(_result,type);
    return _result;
  }
  ...
  public static String getType(IRNode node) {
    Operator op = tree.getOperator(node);
    if (!(op instanceof NamedType)) {
      throw new IllegalArgumentException("node not NamedType: "+op);
    }
