// Generated from C:\eclipse\workspace\fluid\code\fluid\java\operator\FloatLiteral.op.  Do *NOT* edit!
...
public class FloatLiteral extends PrimLiteral 
    { 
  protected FloatLiteral() {}

  public static final FloatLiteral prototype = new FloatLiteral();
  ...
  public static String getToken(IRNode node) {
    ...
    if (!(op instanceof FloatLiteral)) {
      throw new IllegalArgumentException("node not FloatLiteral: "+op);
    }
