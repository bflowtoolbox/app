// Generated from C:\eclipse\workspace\fluid\code\fluid\java\operator\GreaterThanExpression.op.  Do *NOT* edit!
...
public class GreaterThanExpression extends CompareExpression 
    ...
    { 
  protected GreaterThanExpression() {}

  public static final GreaterThanExpression prototype = new GreaterThanExpression();
  ...
  public static IRNode getExpr1(IRNode node) {
    ...
    if (!(op instanceof GreaterThanExpression)) {
      throw new IllegalArgumentException("node not GreaterThanExpression: "+op);
    }
