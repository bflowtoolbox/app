// Generated from C:\eclipse\workspace\fluid\code\fluid\java\operator\NotEqExpression.op.  Do *NOT* edit!
...
public class NotEqExpression extends EqualityExpression 
    implements DripOperator 
    { 
  protected NotEqExpression() {}

  public static final NotEqExpression prototype = new NotEqExpression();

  public Operator superOperator() {
    return EqualityExpression.prototype;
  }
  ...
  public static IRNode getOp1(IRNode node) {
    ...
    if (!(op instanceof NotEqExpression)) {
      throw new IllegalArgumentException("node not NotEqExpression: "+op);
    }
