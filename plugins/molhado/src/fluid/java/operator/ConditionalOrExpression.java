// Generated from C:\eclipse\workspace\fluid\code\fluid\java\operator\ConditionalOrExpression.op.  Do *NOT* edit!
...
public class ConditionalOrExpression extends BinopExpression 
    implements DripOperator 
    { 
  protected ConditionalOrExpression() {}

  public static final ConditionalOrExpression prototype = new ConditionalOrExpression();
  ...
  public static IRNode getCond1(IRNode node) {
    ...
    if (!(op instanceof ConditionalOrExpression)) {
      throw new IllegalArgumentException("node not ConditionalOrExpression: "+op);
    }
