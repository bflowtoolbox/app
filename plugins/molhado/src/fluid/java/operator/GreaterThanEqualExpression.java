// Generated from C:\eclipse\workspace\fluid\code\fluid\java\operator\GreaterThanEqualExpression.op.  Do *NOT* edit!
...
public class GreaterThanEqualExpression extends CompareExpression 
    ...
    { 
  protected GreaterThanEqualExpression() {}

  public static final GreaterThanEqualExpression prototype = new GreaterThanEqualExpression();
  ...
  public static IRNode getExpr1(IRNode node) {
    ...
    if (!(op instanceof GreaterThanEqualExpression)) {
      throw new IllegalArgumentException("node not GreaterThanEqualExpression: "+op);
    }
