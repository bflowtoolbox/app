// Generated from C:\eclipse\workspace\fluid\code\fluid\java\operator\XorExpression.op.  Do *NOT* edit!
...
public class XorExpression extends LogBinopExpression { 
  protected XorExpression() {}

  public static final XorExpression prototype = new XorExpression();

  public Operator superOperator() {
    return LogBinopExpression.prototype;
  }
  ...
  public static IRNode getOp1(IRNode node) {
    ...
    if (!(op instanceof XorExpression)) {
      throw new IllegalArgumentException("node not XorExpression: "+op);
    }
