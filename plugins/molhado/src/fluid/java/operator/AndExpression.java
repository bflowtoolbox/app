// Generated from C:\eclipse\workspace\fluid\code\fluid\java\operator\AndExpression.op.  Do *NOT* edit!
...
public class AndExpression extends LogBinopExpression { 
  protected AndExpression() {}

  public static final AndExpression prototype = new AndExpression();
  ...
  public static IRNode getOp1(IRNode node) {
    ...
    if (!(op instanceof AndExpression)) {
      throw new IllegalArgumentException("node not AndExpression: "+op);
    }
