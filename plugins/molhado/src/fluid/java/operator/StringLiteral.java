// Generated from C:\eclipse\workspace\fluid\code\fluid\java\operator\StringLiteral.op.  Do *NOT* edit!
...
public class StringLiteral extends RefLiteral 
    { 
  protected StringLiteral() {}

  public static final StringLiteral prototype = new StringLiteral();
  ...
  public static String getToken(IRNode node) {
    ...
    if (!(op instanceof StringLiteral)) {
      throw new IllegalArgumentException("node not StringLiteral: "+op);
    }
