// Generated from C:\eclipse\workspace\fluid\code\fluid\java\operator\SubExpression.op.  Do *NOT* edit!
...
public class SubExpression extends ArithBinopExpression 
    implements DripOperator 
    { 
  protected SubExpression() {}

  public static final SubExpression prototype = new SubExpression();
  ...
  public static IRNode getOp1(IRNode node) {
    ...
    if (!(op instanceof SubExpression)) {
      throw new IllegalArgumentException("node not SubExpression: "+op);
    }
