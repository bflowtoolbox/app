// Generated from C:\eclipse\workspace\fluid\code\fluid\java\operator\PreDecrementExpression.op.  Do *NOT* edit!
...
public class PreDecrementExpression extends CrementExpression { 
  protected PreDecrementExpression() {}

  public static final PreDecrementExpression prototype = new PreDecrementExpression();
  ...
  public static IRNode getOp(IRNode node) {
    ...
    if (!(op instanceof PreDecrementExpression)) {
      throw new IllegalArgumentException("node not PreDecrementExpression: "+op);
    }
