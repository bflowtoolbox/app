// Generated from C:\eclipse\workspace\fluid\code\fluid\java\operator\RemExpression.op.  Do *NOT* edit!
...
public class RemExpression extends DivRemExpression 
    { 
  protected RemExpression() {}

  public static final RemExpression prototype = new RemExpression();
  ...
  public static IRNode getOp1(IRNode node) {
    ...
    if (!(op instanceof RemExpression)) {
      throw new IllegalArgumentException("node not RemExpression: "+op);
    }
