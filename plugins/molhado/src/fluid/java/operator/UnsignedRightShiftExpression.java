// Generated from C:\eclipse\workspace\fluid\code\fluid\java\operator\UnsignedRightShiftExpression.op.  Do *NOT* edit!
...
public class UnsignedRightShiftExpression extends ShiftExpression { 
  protected UnsignedRightShiftExpression() {}

  public static final UnsignedRightShiftExpression prototype = new UnsignedRightShiftExpression();

  public Operator superOperator() {
    return ShiftExpression.prototype;
  }
  ...
  public static IRNode getOp1(IRNode node) {
    ...
    if (!(op instanceof UnsignedRightShiftExpression)) {
      throw new IllegalArgumentException("node not UnsignedRightShiftExpression: "+op);
    }
