// Generated from C:\eclipse\workspace\fluid\code\fluid\java\operator\CharLiteral.op.  Do *NOT* edit!
...
public class CharLiteral extends PrimLiteral 
    { 
  protected CharLiteral() {}

  public static final CharLiteral prototype = new CharLiteral();
  ...
  public static String getToken(IRNode node) {
    ...
    if (!(op instanceof CharLiteral)) {
      throw new IllegalArgumentException("node not CharLiteral: "+op);
    }
