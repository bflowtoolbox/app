// Generated from C:\eclipse\workspace\fluid\code\fluid\java\operator\RightShiftExpression.op.  Do *NOT* edit!
...
public class RightShiftExpression extends ShiftExpression { 
  protected RightShiftExpression() {}

  public static final RightShiftExpression prototype = new RightShiftExpression();
  ...
  public static IRNode getOp1(IRNode node) {
    ...
    if (!(op instanceof RightShiftExpression)) {
      throw new IllegalArgumentException("node not RightShiftExpression: "+op);
    }
