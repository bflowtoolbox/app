// Generated from C:\eclipse\workspace\fluid\code\fluid\java\operator\PlusExpression.op.  Do *NOT* edit!
...
public class PlusExpression extends ArithUnopExpression { 
  protected PlusExpression() {}

  public static final PlusExpression prototype = new PlusExpression();
  ...
  public static IRNode getOp(IRNode node) {
    ...
    if (!(op instanceof PlusExpression)) {
      throw new IllegalArgumentException("node not PlusExpression: "+op);
    }
