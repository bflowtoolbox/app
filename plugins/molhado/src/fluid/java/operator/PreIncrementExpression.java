// Generated from C:\eclipse\workspace\fluid\code\fluid\java\operator\PreIncrementExpression.op.  Do *NOT* edit!
...
public class PreIncrementExpression extends CrementExpression { 
  protected PreIncrementExpression() {}

  public static final PreIncrementExpression prototype = new PreIncrementExpression();
  ...
  public static IRNode getOp(IRNode node) {
    ...
    if (!(op instanceof PreIncrementExpression)) {
      throw new IllegalArgumentException("node not PreIncrementExpression: "+op);
    }
