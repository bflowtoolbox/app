// Generated from C:\eclipse\workspace\fluid\code\fluid\java\operator\AddExpression.op.  Do *NOT* edit!
...
public class AddExpression extends ArithBinopExpression 
    implements DripOperator 
    { 
  protected AddExpression() {}

  public static final AddExpression prototype = new AddExpression();
  ...
  public static IRNode getOp1(IRNode node) {
    ...
    if (!(op instanceof AddExpression)) {
      throw new IllegalArgumentException("node not AddExpression: "+op);
    }
...
SyntaxTreeInterface tree = unparser.getTree();
  ...
  public int childPrecedence(int i) {
    switch (i) {
    case 0: return addLeft;
    case 1: return addRight;
    default: return 0;
    }
  }
