// Generated from C:\eclipse\workspace\fluid\code\fluid\java\operator\StringConcat.op.  Do *NOT* edit!
...
public class StringConcat extends ArithBinopExpression 
    implements DripOperator 
    { 
  protected StringConcat() {}

  public static final StringConcat prototype = new StringConcat();
  ...
  public static IRNode getOp1(IRNode node) {
    ...
    if (!(op instanceof StringConcat)) {
      throw new IllegalArgumentException("node not StringConcat: "+op);
    }
