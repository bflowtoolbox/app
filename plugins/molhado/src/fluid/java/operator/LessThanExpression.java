// Generated from C:\eclipse\workspace\fluid\code\fluid\java\operator\LessThanExpression.op.  Do *NOT* edit!
...
public class LessThanExpression extends CompareExpression 
  ...
  public static final LessThanExpression prototype = new LessThanExpression();
  ...
  public static IRNode getExpr1(IRNode node) {
    ...
    if (!(op instanceof LessThanExpression)) {
      throw new IllegalArgumentException("node not LessThanExpression: "+op);
    }
