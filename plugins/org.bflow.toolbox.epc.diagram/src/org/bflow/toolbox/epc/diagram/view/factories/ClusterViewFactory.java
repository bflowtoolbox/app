 ...
 * @generated
 */
public class ClusterViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		getViewService().createNode(eObjectAdapter, view,
				EpcVisualIDRegistry.getType(ClusterNameEditPart.VISUAL_ID),
		...
		BflowDiagramEditPart.apply(ClusterEditPart.class, style);
