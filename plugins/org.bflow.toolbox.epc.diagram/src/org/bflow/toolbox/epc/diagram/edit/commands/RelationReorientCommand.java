...
public class RelationReorientCommand extends EditElementCommand {
	...
	protected boolean canReorientSource() {
		...
		if (!(getLink().eContainer() instanceof Epc)) {
			return false;
		}
		Epc container = (Epc) getLink().eContainer();
		return EpcBaseItemSemanticEditPolicy.LinkConstraints
				.canExistRelation_4002(container, getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		Epc container = (Epc) getLink().eContainer();
		return EpcBaseItemSemanticEditPolicy.LinkConstraints
				.canExistRelation_4002(container, source, getNewTarget());
	}
