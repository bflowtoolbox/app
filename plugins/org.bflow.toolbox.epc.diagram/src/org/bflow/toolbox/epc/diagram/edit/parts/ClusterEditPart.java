...
import org.bflow.toolbox.epc.diagram.edit.policies.ClusterItemSemanticEditPolicy;
...
public class ClusterEditPart extends BflowNodeEditPart {
	...
	public class ClusterFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			fFigureClusterNameFigure
					.setTextJustification(PositionConstants.CENTER);
			fFigureClusterNameFigure.setTextWrap(true);

			fFigureClusterNameFigure.setBorder(new MarginBorder(getMapMode()
	...
	public WrappingLabel[] getLabels() {
		return new WrappingLabel[] { ((ClusterFigure) primaryShape)
				.getFigureClusterNameFigure() };
	}
}
