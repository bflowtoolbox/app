 ...
 * @generated
 */
public class InformationArcCreateCommand extends CreateElementCommand {
	 ...
	 * @generated
	 */
	public InformationArcCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return EpcBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateInformationArc_4003(getContainer(), getSource(),
						getTarget());
	}
	...
	protected EObject doDefaultElementCreation() {
		InformationArc newElement = EpcFactory.eINSTANCE.createInformationArc();
