...
import org.bflow.toolbox.epc.diagram.edit.policies.EventItemSemanticEditPolicy;
...
public class EventEditPart extends BflowNodeEditPart {
	...
	public class EventFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			eventPolygonFigure0.addPoint(new Point(getMapMode().DPtoLP(90),
					getMapMode().DPtoLP(50)));
			eventPolygonFigure0.addPoint(new Point(getMapMode().DPtoLP(100),
					getMapMode().DPtoLP(25)));
			eventPolygonFigure0.addPoint(new Point(getMapMode().DPtoLP(90),
					getMapMode().DPtoLP(0)));
			eventPolygonFigure0.addPoint(new Point(getMapMode().DPtoLP(10),
			...
			fFigureEventNameFigure.setAlignment(PositionConstants.CENTER);
			fFigureEventNameFigure
					.setTextJustification(PositionConstants.CENTER);
			fFigureEventNameFigure.setTextWrap(true);
		...
		private void layoutLabelContainer(Shape figure, final int offset) {
			...
			StackLayout layoutEventPolygonFigure0 = new StackLayout() {
				...
				public void layout(IFigure figure) {
					...
					Rectangle r = new Rectangle(figure.getBounds().x + offset,
							figure.getBounds().y + insets,
							figure.getBounds().width - 2 * offset, figure
									.getBounds().height
									- 2 * insets);
