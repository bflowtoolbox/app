...
import org.bflow.toolbox.epc.diagram.edit.policies.DocumentItemSemanticEditPolicy;
...
public class DocumentEditPart extends BflowNodeEditPart {
	...
	public class DocumentFigure extends RectangleFigure {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureDocumentNameFigure;
		...
		private void createContents() {
			...
			fFigureDocumentNameFigure = new WrappingLabel();
			fFigureDocumentNameFigure.setText("");
			fFigureDocumentNameFigure.setAlignment(PositionConstants.CENTER);
			fFigureDocumentNameFigure
					.setTextJustification(PositionConstants.CENTER);
			fFigureDocumentNameFigure.setTextWrap(true);
			fFigureDocumentNameFigure.setBorder(new MarginBorder(getMapMode()
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureDocumentNameFigure() {
