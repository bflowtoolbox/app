...
public class EpcNavigator extends ViewPart {
	...
	private void hookContextMenu() {
		...
		menuMgr.addMenuListener(new IMenuListener() {
			public void menuAboutToShow(IMenuManager manager) {
				EpcNavigator.this.fillContextMenu(manager);
			}
		});
	...
	private void newFile(File datei) {
		try {
			...
			bw.newLine();
			bw
					.write("<xmi:XMI xmi:version=\"2.0\" xmlns:xmi=\"http://www.omg.org/XMI\" xmlns:bflow=\"org.bflow.toolbox.bflow\" xmlns:notation=\"http://www.eclipse.org/gmf/runtime/1.0.1/notation\">");
			bw.newLine();
			bw.write("<bflow:Bflow xmi:id=\"_xpddYAVkEd2zmcwJ2MNmpA\"/>");
			bw.newLine();
			bw
	...
	private void showMessage(String message) {
		...
		messageBox.setText("EpcNavigatorView");
		messageBox.open();
	}
	...
	private void function0(String Filename) {
		try {
			if (myFile.equals("default.epc") || myFile.equals("default")) {
				...
				if (!Datei.getName().endsWith(".epc")) {
					Datei = new File(Filename + "/" + myFile + ".epc");
				}
	...
	public void dragSupport() {
		viewer.addDragSupport(DND.DROP_COPY, new Transfer[] { LocalTransfer
			...
			public void dragFinished(DragSourceEvent event) {
				...
				if (DragHelper.dropTarget.getClass().toString().equals(
						"class org.bflow.toolbox.epc.diagram.edit.parts.FunctionEditPart")) {
					FunctionEditPart funcEdit = ((FunctionEditPart) DragHelper.dropTarget);
					Function func = (Function) funcEdit.getPrimaryView()
							.getElement();
					func.getSubdiagram().add(DragHelper.data);
				} else if (DragHelper.dropTarget
						.getClass()
						.toString()
						.equals(
								"class org.bflow.toolbox.epc.diagram.edit.parts.ProcessInterfaceEditPart")) {
