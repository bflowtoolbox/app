 ...
 * @generated
 */
public class CardFileViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = EpcVisualIDRegistry
					.getType(CardFileEditPart.VISUAL_ID);
		...
		getViewService().createNode(eObjectAdapter, view,
				EpcVisualIDRegistry.getType(CardFileNameEditPart.VISUAL_ID),
		...
		BflowDiagramEditPart.apply(CardFileEditPart.class, style);
