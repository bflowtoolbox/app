 ...
 * @generated
 */
public class ApplicationViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		getViewService().createNode(eObjectAdapter, view,
				EpcVisualIDRegistry.getType(ApplicationNameEditPart.VISUAL_ID),
		...
		BflowDiagramEditPart.apply(ApplicationEditPart.class, style);
