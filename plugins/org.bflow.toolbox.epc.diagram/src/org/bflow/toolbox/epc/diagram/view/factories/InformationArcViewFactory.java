 ...
 * @generated
 */
public class InformationArcViewFactory extends ConnectionViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = EpcVisualIDRegistry
					.getType(InformationArcEditPart.VISUAL_ID);
		...
		BflowDiagramEditPart.apply(InformationArcEditPart.class, style);
	}
}
