 ...
 * @generated
 */
public class ProcessInterfaceViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = EpcVisualIDRegistry
					.getType(ProcessInterfaceEditPart.VISUAL_ID);
		...
		BflowDiagramEditPart.apply(ProcessInterfaceEditPart.class, style);
