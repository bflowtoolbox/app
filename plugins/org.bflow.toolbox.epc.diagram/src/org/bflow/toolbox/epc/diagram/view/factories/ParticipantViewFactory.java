 ...
 * @generated
 */
public class ParticipantViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		getViewService().createNode(eObjectAdapter, view,
				EpcVisualIDRegistry.getType(ParticipantNameEditPart.VISUAL_ID),
		...
		BflowDiagramEditPart.apply(ParticipantEditPart.class, style);
