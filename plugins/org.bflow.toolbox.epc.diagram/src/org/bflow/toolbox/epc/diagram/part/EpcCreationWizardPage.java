 ...
 */
public class EpcCreationWizardPage extends WizardNewFileCreationPage {
	 ...
	 * @generated
	 */
	public EpcCreationWizardPage(String pageName, IWorkbench workbench, 
	...
	public void createControl(Composite parent) {
		...
		setFileName(EpcDiagramEditorUtil.getUniqueFileName(
	...
	protected boolean validatePage() {
		...
		if (extension != null
			...
			setErrorMessage(NLS.bind(
					Messages.EpcCreationWizardPageExtensionError, extension));
			return false;
		}*/
		return true;
	}
