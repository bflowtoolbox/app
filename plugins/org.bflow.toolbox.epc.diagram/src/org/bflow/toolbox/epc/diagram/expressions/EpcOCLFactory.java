...
public class EpcOCLFactory {
	...
	protected EpcOCLFactory() {
		...
		this.expressionBodies = new String[] {
				...
				//Regeln IARC
				"((self <> oppositeEnd) and (self.oclIsKindOf(Function) or self.oclIsKindOf(Product) or self.oclIsKindOf(Objective) or self.oclIsKindOf(TechnicalTerm) or self.oclIsKindOf(File) or self.oclIsKindOf(Document) or self.oclIsKindOf(Cluster) or self.oclIsKindOf(CardFile)))", //$NON-NLS-1$
				"((self.oclIsTypeOf(Function) and (oppositeEnd.oclIsKindOf(Product) or oppositeEnd.oclIsKindOf(Objective) or oppositeEnd.oclIsKindOf(TechnicalTerm) or oppositeEnd.oclIsKindOf(File) or oppositeEnd.oclIsKindOf(Document) or oppositeEnd.oclIsKindOf(Cluster) or oppositeEnd.oclIsKindOf(CardFile))) or (oppositeEnd.oclIsTypeOf(Function) and (self.oclIsKindOf(Product) or self.oclIsKindOf(Objective) or self.oclIsKindOf(TechnicalTerm) or self.oclIsKindOf(File) or self.oclIsKindOf(Document) or self.oclIsKindOf(Cluster) or self.oclIsKindOf(CardFile))))", //$NON-NLS-1$
				
				//Regeln RELATION
				"((self <> oppositeEnd) and (self.oclIsKindOf(Function) or self.oclIsKindOf(PersonType) or self.oclIsKindOf(Participant) or self.oclIsKindOf(Group) or self.oclIsKindOf(Location) or self.oclIsKindOf(Position) or self.oclIsKindOf(InternalPerson) or self.oclIsKindOf(ExternalPerson) or self.oclIsKindOf(Application)))", //$NON-NLS-1$
