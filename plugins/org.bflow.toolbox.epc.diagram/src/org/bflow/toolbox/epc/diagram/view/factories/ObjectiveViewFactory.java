 ...
 * @generated
 */
public class ObjectiveViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		getViewService().createNode(eObjectAdapter, view,
				EpcVisualIDRegistry.getType(ObjectiveNameEditPart.VISUAL_ID),
		...
		BflowDiagramEditPart.apply(ObjectiveEditPart.class, style);
