 ...
 * @generated
 */
public class EpcElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public EpcElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell().setText(
				Messages.EpcElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "epc".equals(fileExtension); //$NON-NLS-1$
	}
