...
import org.bflow.toolbox.epc.diagram.edit.policies.LocationItemSemanticEditPolicy;
...
public class LocationEditPart extends BflowNodeEditPart {
	...
	public class LocationFigure extends Ellipse {
		...
		private void createContents() {
			...
			fFigureLocationNameFigure.setAlignment(PositionConstants.CENTER);
			fFigureLocationNameFigure
					.setTextJustification(PositionConstants.CENTER);
			fFigureLocationNameFigure.setTextWrap(true);

			this.add(nameContainer0);

			nameContainer = nameContainer0;
			nameContainer0.add(fFigureLocationNameFigure);
		}
		...
		private Border createBorder0() {
			LocationBorder result = new LocationBorder();
	...
	public WrappingLabel[] getLabels() {
		return new WrappingLabel[] { ((LocationFigure) primaryShape)
				.getFigureLocationNameFigure() };
	}
}
