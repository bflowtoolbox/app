 ...
 * @generated
 */
public class DocumentViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		getViewService().createNode(eObjectAdapter, view,
				EpcVisualIDRegistry.getType(DocumentNameEditPart.VISUAL_ID),
		...
		BflowDiagramEditPart.apply(DocumentEditPart.class, style);
