 ...
 * @generated
 */
public class PersonTypeViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = EpcVisualIDRegistry
					.getType(PersonTypeEditPart.VISUAL_ID);
		...
		getViewService().createNode(eObjectAdapter, view,
				EpcVisualIDRegistry.getType(PersonTypeNameEditPart.VISUAL_ID),
		...
		BflowDiagramEditPart.apply(PersonTypeEditPart.class, style);
