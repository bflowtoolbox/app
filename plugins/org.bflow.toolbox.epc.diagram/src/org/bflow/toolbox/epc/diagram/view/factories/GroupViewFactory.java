...
public class GroupViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = EpcVisualIDRegistry.getType(GroupEditPart.VISUAL_ID);
		...
		getViewService().createNode(eObjectAdapter, view,
				EpcVisualIDRegistry.getType(GroupNameEditPart.VISUAL_ID),
		...
		BflowDiagramEditPart.apply(GroupEditPart.class, style);
