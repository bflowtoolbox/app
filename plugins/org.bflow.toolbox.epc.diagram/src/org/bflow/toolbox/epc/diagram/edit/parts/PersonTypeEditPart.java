...
import org.bflow.toolbox.epc.diagram.edit.policies.PersonTypeItemSemanticEditPolicy;
...
public class PersonTypeEditPart extends BflowNodeEditPart {
	...
	protected IFigure createNodeShape() {
		PersonTypeFigure figure = new PersonTypeFigure();
	...
	public class PersonTypeFigure extends RectangleFigure {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigurePersonTypeNameFigure;
		...
		public PersonTypeFigure() {
			...
			this.setBorder(new CompoundBorder(new MarginBorder(getMapMode()
		...
		private void createContents() {
			...
			fFigurePersonTypeNameFigure = new WrappingLabel();
			fFigurePersonTypeNameFigure.setText("");
			fFigurePersonTypeNameFigure.setAlignment(PositionConstants.CENTER);
			fFigurePersonTypeNameFigure
					.setTextJustification(PositionConstants.CENTER);
			fFigurePersonTypeNameFigure.setTextWrap(true);
			fFigurePersonTypeNameFigure.setBorder(new MarginBorder(getMapMode()
		...
		private Border createBorder0() {
			PersonTypeBorder result = new PersonTypeBorder();
		 ...
		 * @generated
		 */
		public WrappingLabel getFigurePersonTypeNameFigure() {
	...
	public WrappingLabel[] getLabels() {
		return new WrappingLabel[] { ((PersonTypeFigure) primaryShape)
				.getFigurePersonTypeNameFigure() };
	}
}
