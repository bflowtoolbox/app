...
import org.bflow.toolbox.epc.impl.ANDImpl;
import org.bflow.toolbox.epc.impl.ORImpl;
import org.bflow.toolbox.epc.impl.XORImpl;
...
public class MySetBoundsCommand extends AbstractTransactionalCommand {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info)
		...
		if (nodeimpl instanceof ORImpl || nodeimpl instanceof XORImpl || nodeimpl instanceof ANDImpl) {
			location.x = location.x-13;
			location.y = location.y-13;
		} else {
