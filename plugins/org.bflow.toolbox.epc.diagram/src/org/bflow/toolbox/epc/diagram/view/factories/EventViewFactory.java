 ...
 * @generated
 */
public class EventViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = EpcVisualIDRegistry.getType(EventEditPart.VISUAL_ID);
		...
		getViewService().createNode(eObjectAdapter, view,
				EpcVisualIDRegistry.getType(EventNameEditPart.VISUAL_ID),
