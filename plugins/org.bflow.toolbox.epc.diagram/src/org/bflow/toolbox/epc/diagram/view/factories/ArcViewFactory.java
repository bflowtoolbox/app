 ...
 * @generated
 */
public class ArcViewFactory extends ConnectionViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = EpcVisualIDRegistry.getType(ArcEditPart.VISUAL_ID);
		...
		BflowDiagramEditPart.apply(ArcEditPart.class, style);
	}
}
