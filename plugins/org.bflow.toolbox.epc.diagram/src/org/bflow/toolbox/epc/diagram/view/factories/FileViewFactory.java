...
public class FileViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = EpcVisualIDRegistry.getType(FileEditPart.VISUAL_ID);
		...
		getViewService().createNode(eObjectAdapter, view,
				EpcVisualIDRegistry.getType(FileNameEditPart.VISUAL_ID),
		...
		BflowDiagramEditPart.apply(FileEditPart.class, style);
